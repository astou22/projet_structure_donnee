...
public class Main {
	...
	Analyzer memory_analysis = new Analyzer();
        ...
        time_analysis.save_values("../plots/dynamic_array_time_javap=0,3.plot");
        copy_analysis.save_values("../plots/dynamic_array_copy_javap=0,3.plot");
	memory_analysis.save_values("../plots/dynamic_array_memory_javaP=0,3.plot");
    }
}
